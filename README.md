...
### This is the new Grott 3.0.0 release

What is new in 3.0.0: 

* Grott and Grottserver are now integrated
* New auto detect mechanisme is implemented to automatically detect inverter type (be aware at this moment not able to detect SPF type inverter)
* In server mode data can be sent to growatt server (be aware data back from growatt will be ignored!)
