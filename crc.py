...
#*
#* stolen from: https://www.digi.com/resources/documentation/digidocs/90001537/references/r_python_crc16_modbus.htm
...
if __name__ == "__main__":
    # Checking if the implementation is the same
    import libscrc
