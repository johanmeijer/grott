...
class Conf : 
    ...
    def set_reclayouts(self):    
        ...
        self.recorddict13 = {"T06NNNNXSPA": {
            ...
            "acchargeenergytodayl": {"value" :654, "length" : 2, "type" : "num", "divide" : 10}, 
            "group2start"        : {"value" :658, "length" : 2, "type" : "num","incl" : "no"}, 
            "group2end"          : {"value" :662, "length" : 2, "type" : "num","incl" : "no"},
            "acchargeenergytodayh": {"value" :666, "length" : 2, "type" : "num", "divide" : 10}, 
            "acchargeenergytotal ": {"value" :670, "length" : 4, "type" : "num", "divide" : 10}, 
